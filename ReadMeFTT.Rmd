...
Becareful there is a temporary password, you need to configure your own password after installation. <br> **DO NOT USE THE SAME PASSWORD FOR YOU COMPUTER (sudo command) AND MYSQL**
for security reason.
